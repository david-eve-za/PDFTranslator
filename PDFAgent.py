...
from tools.FileFinder import FilesFinder  # Asumimos que PDFv1/FileFinder.py existe
from tools.TextExtractor import TextExtractorAgent  # Asumimos que PDFv1/TextExtractor.py existe
from tools.Translator import TranslatorAgent  # Asumimos que PDFv1/Translator.py existe
